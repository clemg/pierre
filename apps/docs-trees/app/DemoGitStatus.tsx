...
import { Button } from '@pierre/docs-shared/components/ui/button';
import {
  ButtonGroup,
  ButtonGroupItem,
} from '@pierre/docs-shared/components/ui/button-group';
import { Switch } from '@pierre/docs-shared/components/ui/switch';
import {
  IconColorDark,
  IconColorLight,
  IconFolders,
...
import type { FileTreePathOptions } from '@/features/trees/fileTreePathOptions';
import type { GitStatusEntry } from '@/features/trees/treesCompat';
      ...
      <FeatureHeader
        ...
        description={
          <>
            Use the{' '}
            <Link
              href="/docs#show-git-status-and-row-annotations"
