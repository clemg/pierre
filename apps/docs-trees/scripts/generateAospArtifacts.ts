...
//
// Run from the repo root: `bun apps/docs-trees/scripts/generateAospArtifacts.ts`.
...
const previewOutputPath = resolvePath(
  repoRoot,
  'apps/docs-trees/app/trees-dev/_lib/aospPreview.ts'
);
const gzOutputDir = resolvePath(repoRoot, 'apps/docs-trees/public/trees-dev');
...
const previewContent = `// Generated by apps/docs-trees/scripts/generateAospArtifacts.ts. Do not edit by hand.
